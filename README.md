...
**After downloading:** Extract and place the `models/` folder in the project root directory. The application and the folder contain the models that were trained only on the YOLOv8s because of the high volume.
